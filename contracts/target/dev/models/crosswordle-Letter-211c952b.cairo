        ...
        dojo::model::Layout::Struct(
            array![
                dojo::model::FieldLayout {
                    selector: 1361281667150571910045040503430228971957882269299110004732613772018861003105,
                    layout: dojo::model::introspect::Introspect::<felt252>::layout()
                },
                dojo::model::FieldLayout {
                    selector: 1769196314026621261694562697659973582903654063632112053879353272658158387938,
...
pub impl LetterEntityStoreImpl of LetterEntityStore {
    ...
    fn get_hash(world: dojo::world::IWorldDispatcher, entity_id: felt252) -> felt252 {
        let mut values = dojo::model::ModelEntity::<
            LetterEntity
        >::get_member(
            world,
            entity_id,
            1361281667150571910045040503430228971957882269299110004732613772018861003105
        );
        let field_value = core::serde::Serde::<felt252>::deserialize(ref values);

        if core::option::OptionTrait::<felt252>::is_none(@field_value) {
            panic!("Field `Letter::hash`: deserialization failed.");
        }

        core::option::OptionTrait::<felt252>::unwrap(field_value)
    }

    fn set_hash(self: @LetterEntity, world: dojo::world::IWorldDispatcher, value: felt252) {
    ...
    fn get_placed_by(world: dojo::world::IWorldDispatcher, entity_id: felt252) -> ContractAddress {
        let mut values = dojo::model::ModelEntity::<
            LetterEntity
        >::get_member(
            world,
            entity_id,
            1769196314026621261694562697659973582903654063632112053879353272658158387938
        );
        ...
        if core::option::OptionTrait::<ContractAddress>::is_none(@field_value) {
            panic!("Field `Letter::placed_by`: deserialization failed.");
        }
...
pub impl LetterStoreImpl of LetterStore {
    ...
    fn get(world: dojo::world::IWorldDispatcher, position: u8) -> Letter {
        let mut serialized = core::array::ArrayTrait::new();
        core::serde::Serde::serialize(@position, ref serialized);
    ...
    fn get_hash(world: dojo::world::IWorldDispatcher, position: u8) -> felt252 {
        let mut serialized = core::array::ArrayTrait::new();
        core::serde::Serde::serialize(@position, ref serialized);
    ...
    fn set_hash(self: @Letter, world: dojo::world::IWorldDispatcher, value: felt252) {
        let mut serialized = core::array::ArrayTrait::new();
        core::serde::Serde::serialize(@value, ref serialized);
    ...
    fn get_placed_by(world: dojo::world::IWorldDispatcher, position: u8) -> ContractAddress {
        let mut serialized = core::array::ArrayTrait::new();
        core::serde::Serde::serialize(@position, ref serialized);
    ...
    fn set_placed_by(self: @Letter, world: dojo::world::IWorldDispatcher, value: ContractAddress) {
        let mut serialized = core::array::ArrayTrait::new();
        core::serde::Serde::serialize(@value, ref serialized);
...
pub impl LetterModelEntityImpl of dojo::model::ModelEntity<LetterEntity> {
    ...
    fn values(self: @LetterEntity) -> Span<felt252> {
        let mut serialized = core::array::ArrayTrait::new();
        core::array::ArrayTrait::append(ref serialized, *self.hash);
        core::serde::Serde::serialize(self.placed_by, ref serialized);
